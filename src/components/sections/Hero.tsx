      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div className="flex flex-col space-y-4 w-full md:w-[58%] text-right">
          ...
          <p className="text-base sm:text-lg md:text-xl leading-relaxed">
            ...
            درگیری با پیچیدگی‌های فنی، روی توسعه‌ی محصولات تمرکر کنن و سریع‌تر
            به بازار برسن.
          </p>
        </div>

        <div className="w-full md:w-auto flex justify-center md:justify-start">
          <button className="font-extralight text-black items-center justify-center w-44 h-12 rounded gap-2 bg-yellow-400 hover:bg-yellow-500 flex">
